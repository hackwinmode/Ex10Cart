...
<asp:Content ID="formContent" ContentPlaceHolderID="formPlaceHolder" Runat="Server">
    ...
    <asp:SqlDataSource ID="SqlDataSource" runat="server" ConnectionString='<%$ ConnectionStrings:HalloweenConnectionString %>' SelectCommand="SELECT * FROM [Products]"></asp:SqlDataSource>
    <div id="productData">   
